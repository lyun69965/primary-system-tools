...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth,height=0.72\textheight,keepaspectratio]{q05.png}
  \caption{第5题：控制一个可清理的后台任务}
  \label{fig:q05}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth,height=0.72\textheight,keepaspectratio]{q06.png}
  \caption{第6题：语义重构与本地开发反馈}
  \label{fig:q06}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth,height=0.72\textheight,keepaspectratio]{q07.png}
  \caption{第7题：用调试器定位归并排序缺陷}
  \label{fig:q07}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth,height=0.72\textheight,keepaspectratio]{q08.png}
  \caption{第8题：先测量再优化词频程序}
  \label{fig:q08}
\end{figure}
